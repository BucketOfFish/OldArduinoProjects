    ...
    switch(func){
      ...
      case 'r':
        ...
        if(readPacket(readBuf, 3)){
          ...
          Serial.print("time of day: ");Serial.print(pNoon);Serial.print(", weather type: "),Serial.print(weatherType);Serial.print(", lightning: ");Serial.println(lightning);
...
//          digitalWrite(13,LOW);
      ...
      case 'f':
        Serial.println("mystery function");
